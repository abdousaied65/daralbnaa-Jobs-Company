...
<div class="body-header border-bottom d-flex py-3">
    <div class="container-fluid">
        ...
        <div class="h-right flex-grow-1 justify-content-end d-flex align-items-center">
            ...
            <div class="d-flex">
                <a class="nav-link text-primary" style="color: #333!important;" href="{{route('employee.profile.edit',Auth::user()->id)}}">
                    <i class="fa fa-user"></i>
                </a>
                <a class="nav-link text-primary" style="color: #333!important;" href="{{route('employee.lock.screen')}}">
                    <i class="fa fa-lock"></i>
                </a>
                <a class="nav-link" style="color: #333!important;" href="{{route('employee.logout')}}"
                   onclick="event.preventDefault();document.getElementById('logout-form-2').submit();"
                   title="Menu collapse"><i class="fa fa-power-off"></i>
                </a>
                <form id="logout-form-2" action="{{ route('employee.logout') }}" method="POST"
                      style="display: none;">
                    @csrf
                </form>
            </div>
                ...
                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                    <div class="card border-0 w240">
                        ...
                        <div class="list-group m-2" @if(App::getLocale() == "ar") style="direction: rtl !important;text-align: right!important;" @endif>
                            <a class="list-group-item list-group-item-action border-0" style="color: #333!important;" href="{{route('employee.logout')}}"
                               onclick="event.preventDefault();document.getElementById('logout-form-2').submit();"
