                            ...
                            <form action="{{route('employee.profile.update',Auth::user()->id)}}" method="POST"
                                ...
                                <div class="row mb-3">
                                    <div class="form-group col-md-6 pull-right ">
                                        ...
                                        <input type="text" class="form-control form-control-lg" required
                                               value="{{ Auth::user()->name_ar }}" name="name">
                                    </div>
                                    <div class="form-group col-md-6 pull-right ">
                                        <label for=""> {{__('main.email')}} </label>
                                        <input type="text" class="form-control text-left form-control-lg" dir="ltr" required
                                ...
                                <div class="row mb-3">
                                    <div class="form-group col-md-6 pull-right ">
                                        ...
                                        <input type="password" class="form-control form-control-lg" style="text-align: left;" dir="ltr"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 pull-right " id="lnWrapper">
                                        ...
                                        <input value="{{$user->phone_number}}" required
                                               class="form-control form-control-lg mg-b-20" style="text-align: left;direction:ltr;"
