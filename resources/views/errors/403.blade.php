                        ...
                        <div class="w-100 p-4 p-md-5 card border-0">
                            ...
                            <form class="row g-1 p-0 p-md-4">
                                <div class="col-12 text-center mb-4">
                                    ...
                                    @if(App::getLocale() == "ar")
                                        <h5>غير مسموح لك</h5>
                                        <span class="text-muted">غير مصرح لك بالدخول الى هنا .. راجع صلاحيات الادارة تأكد منها وحاول مجددا </span>
                                    @else
                                        <h5>OOP! UnAuthorized</h5>
                                        <span class="text-muted">Sorry, you are unauthorized. check the privileges and try again</span>
                                    @endif
                                </div>
                                <div class="col-12 text-center">
                                    <a href="{{route('supervisor.home')}}" title="" class="btn btn-lg btn-block btn-dark lift text-uppercase">
                                        @if(App::getLocale() == "ar")
