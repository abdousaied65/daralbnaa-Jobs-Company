                        ...
                        <div class="w-100 p-4 p-md-5 card border-0">
                            ...
                            <form class="row g-1 p-0 p-md-4">
                                <div class="col-12 text-center mb-4">
                                    ...
                                    @if(App::getLocale() == "ar")
                                        <h5>الصفحة المطلوبة غير موجوده</h5>
                                        <span class="text-muted">
                                            نعتذر لك .. الصفحة المطلوبة غير موجوده .. اذا كنت تعتقد ان ثمة شئ ما غير صحيح .. ابلغ عن المشكلة للادارة
                                        </span>
                                    @else
                                        <h5>OOP! PAGE NOT FOUND</h5>
                                        <span class="text-muted">Sorry, the page you're looking for doesn;t exist. if you think something is brlken, report a problem.</span>                                    @endif
                                </div>
