                        ...
                        <div class="w-100 p-4 p-md-5 card border-0">
                            ...
                            <form class="row g-1 p-0 p-md-4">
                                <div class="col-12 text-center mb-4">
                                    ...
                                    @if(App::getLocale() == "ar")
                                        <h5>التطبيق قيد الصيانة مؤقتا</h5>
                                        <span class="text-muted">
                                            نعتذر لك جدا .. الخادم غير قادر على اكمال طلبك حاليا
                                    </span>
                                    @else
                                        <h5>The app is down due to maintenance</h5>
                                        <span class="text-muted">
                                        We're sorry, but the server was unable to complete your request.
                                    </span>
                                    @endif
