...
<html>
<head>
    <title> {{__('main.print_nationalities')}} </title>
    <meta charset="utf-8"/>
...
<table class="table table-bordered table-container">
    ...
    <tr>
        <td class="text-center">
            <h4>{{__('main.print_nationalities')}}</h4>
        </td>
    </tr>
    <tr>
        <td>
            <table dir="rtl" class="table table-condensed display table-bordered text-center">
                ...
                <tr>
                    ...
                    <th class="border-bottom-0 text-center"> {{__('main.nationality')}} {{__('main.arabic')}}</th>
                    <th class="border-bottom-0 text-center"> {{__('main.nationality')}} {{__('main.english')}}</th>
                </tr>
                </thead>
                <tbody>
                @php
