...
<html>
<head>
    <title> {{__('main.print_projects')}} </title>
    <meta charset="utf-8"/>
        ...
        <td>
            <table dir="rtl" class="table table-condensed display table-bordered text-center">
                ...
                <tr>
                    ...
                    <th class="border-bottom-0 text-center"> {{__('main.project_name')}} {{__('main.arabic')}}</th>
                    <th class="border-bottom-0 text-center"> {{__('main.project_name')}} {{__('main.english')}}</th>
                    <th class="border-bottom-0 text-center"> {{__('main.dept_name')}}</th>
                    <th class="border-bottom-0 text-center"> {{__('main.added_date')}}</th>
                    <th class="border-bottom-0 text-center"> {{__('main.project_end_date')}}</th>
                </tr>
                </thead>
                <tbody>
                @php
