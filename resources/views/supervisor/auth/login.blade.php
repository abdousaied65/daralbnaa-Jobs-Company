                        ...
                        <div class="w-100 p-4 p-md-5 card border-0" style="max-width: 32rem;">
                            ...
                            <form action="{{ route('supervisor.login') }}" method="POST" class="row g-1 p-0 p-md-4">
                                ...
                                <div class="col-12 text-center mb-5">
                                    ...
                                    <h1>{{__('main.login')}}</h1>
                                    <span>{{__('main.admin_control_panel')}}</span>
                                </div>
                                <div class="col-12">
                                    <div class="mb-2">
                                        <label class="form-label">{{__('main.phone_number')}}</label>
                                        <input required type="number" dir="ltr" name="phone_number"
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        @if (Route::has('supervisor.forget.password.get'))
                                            <div class="form-label">
                                                <span class="d-flex justify-content-between align-items-center">
                                                    {{__('main.password')}}
                                                    <a class="text-primary"
                                                       href="{{ route('supervisor.forget.password.get') }}">{{__('main.forgot_password')}}</a>
                                                </span>
                                            </div>
                                        @endif
