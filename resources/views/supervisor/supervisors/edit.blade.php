            ...
            <div class="card">
                <div class="card-header py-3 bg-transparent border-bottom-0">
                    <h6 class="card-title mb-0"><strong>
                            {{__('main.edit_supervisor')}}
                        </strong></h6>
                </div>
                <div class="card-body">
                    <form class="row g-3" action="{{route('supervisor.supervisors.update',$supervisor->id)}}"
                          method="post"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <fieldset class="form-icon-group left-icon position-relative">
                                <input required dir="rtl" type="text" name="supervisor_name_ar"
                                       value="{{$supervisor->supervisor_name_ar}}"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <fieldset class="form-icon-group left-icon position-relative">
                                <input required dir="ltr" type="text" name="supervisor_name_en"
                                       value="{{$supervisor->supervisor_name_en}}"
                                       class="form-control form-control-lg">
                                <div class="form-icon position-absolute">
                                    <i class="fa fa-pencil"></i>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <fieldset class="form-icon-group left-icon position-relative">
                                <input required dir="ltr" type="email" name="email" value="{{$supervisor->email}}"
                                       class="form-control form-control-lg">
                                <div class="form-icon position-absolute">
                                    <i class="fa fa-pencil"></i>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select id="projects" name="projects[]"
                                ...
                                @foreach($supervisor->projects as $project)
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <input type="number" value="{{$supervisor->phone_number}}" required
                                   class="form-control form-control-lg" dir="ltr" name="phone_number"/>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select required name="job_title_id" id="job_title_id"
                                ...
                                @foreach($job_titles as $job_title)
                                    <option
                                        @if($supervisor->job_title_id == $job_title->id)
                                        selected
                                        @endif
                                        value="{{$job_title->id}}">
                                        @if(App::getLocale() == "ar")
