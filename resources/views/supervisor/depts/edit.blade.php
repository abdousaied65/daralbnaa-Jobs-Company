    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($dept, ['method' => 'PATCH','class' => 'row g-3','enctype' => 'multipart/form-data','route' => ['supervisor.depts.update', $dept->id]]) !!}
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <label class="col-form-label">{{__('main.dept_name')}} {{__('main.arabic')}}</label>
                        <fieldset class="form-icon-group left-icon position-relative">
                            <input required type="text" dir="rtl" value="{{$dept->dept_name_ar}}" name="dept_name_ar"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <fieldset class="form-icon-group left-icon position-relative">
                            <input required type="text" dir="ltr" value="{{$dept->dept_name_en}}" name="dept_name_en"
                                   class="form-control form-control-lg">
                            <div class="form-icon position-absolute">
                                <i class="fa fa-pencil"></i>
                            </div>
